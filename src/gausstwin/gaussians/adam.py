...
def adam_step_kernel_float(
    g: wp.array(dtype=float), # type: ignore
    m: wp.array(dtype=float), # type: ignore 
    v: wp.array(dtype=float), # type: ignore
    lr: float,
    beta1: float,
    beta2: float,
    t: float,
...
def adam_step_kernel_half(
    g: wp.array(dtype=wp.float16), # type: ignore
    m: wp.array(dtype=float),      # type: ignore
    v: wp.array(dtype=float),      # type: ignore
    lr: float,
    beta1: float,
    ...
    t: float,
    eps: float,
    params: wp.array(dtype=wp.float16), # type: ignore
):
    i = wp.tid()
